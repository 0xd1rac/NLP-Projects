...
from config.SimpleRNNConfig import *
...
if __name__ == '__main__':
    ...
    if IS_TEACHER_FORCING:
          print(f"[INFO] Training Simple RNN for {NUM_EPOCHS} epochs with teacher forcing ratio, {TEACHER_FORCING_RATIO}.")
    else:
          print(f"[INFO] Training Simple RNN for {NUM_EPOCHS} epochs without teacher forcing.")
